  ...
  return (
    <Container>
      ...
      <div className="content">
        <div className="first">
          <Unity unityTitle={'Search Data'} backgroundColor={'#68C9BA'}
          svg={<SearchMan/>}>
          ...
          <Unity unityTitle={'24 Hours Access'} backgroundColor={'#9C69E2'}
          svg={<MonkGirl />}>
        ...
        <div className="second">
          <Unity unityTitle={'Print Out'} backgroundColor={'#F063BB'}
          svg={<Print />}>
            Print out service gives you convenience if someday you need print data, just edit it all and just print it.
          </Unity>

          <Unity unityTitle={'Security Code'} backgroundColor={'#2D9CDB'}
          svg={<LockGirl />}>
